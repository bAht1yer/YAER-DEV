...
const features = [
  {
    icon: <BookOpen className="w-6 h-6 text-[#F1F0E9]" />,
    title: "道德經 (Tao Te Ching)",
    description:
      "Explore the full 81 chapters of Laozi's profound philosophy. Features bilingual support (Original Chinese & English translation), category tags, and search functionality.",
    image: "/projects/digitao/chapters.png",
    imageAlt: "Tao Te Ching Chapters Grid",
    bg: "bg-[#F1F0E9]/5",
    border: "border-[#F1F0E9]/20",
  },
  {
    icon: <Bot className="w-6 h-6 text-primary" />,
    title: "智慧問答 (Interpreter)",
    description:
      "An AI-powered interpreter that provides spiritual guidance to modern life questions using principles from the Tao.",
  ...
  },
  {
    ...
    title: "靜坐 (Meditation)",
    description:
      "Cultivate inner peace with highly configurable timers and immersive high-quality ambient soundscapes like 'Forest Stream' or 'Pure Silence'.",
  ...
  },
  {
    ...
    description:
      "Holistic health advice synchronized with the traditional 24 Solar Terms, offering dietary, lifestyle, and exercise recommendations tailored to the current season.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            A seamless blend of ancient wisdom and modern technology, featuring
            an immersive, distraction-free environment designed to help you
            focus on the Tao.
          </p>
        </motion.div>
