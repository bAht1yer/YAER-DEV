            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed">
                        From deploying autonomous <span className="text-primary">AI chatflows</span> to architecting
                        <span className="text-primary"> full-stack platforms</span>, I specialize in bridging the gap between emerging AI capabilities and scalable web infrastructure.
                    </p>
                </motion.div>
